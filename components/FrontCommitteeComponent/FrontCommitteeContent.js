...
const FrontCommitteeContent = () => {
  return (
    ...
    <Row className=' d-flex align-content-center align-items-center justify-content-center'>
      <Col className='px-5  col-lg-4 col-12' style={{marginTop:"-20px"}}>
      ...
      <Col className='px-5 px-lg-0  py-3 '>
      <Row>
      <p className='p-0'>
    ...
    <Row className='mb-5 px-6' style={{paddingLeft:"50px" , paddingRight:"50px"}}>
      <Col className='col-lg-3  d-lg-flex d-none'></Col>
      <Col className='col-lg-6 d-flex gap-4 flex-lg-row flex-column px-5'> 
        
        <Link href="/ficac-committees/central-committees" className='text-decoration-none'>
        <div className='px-3 py-3 py-lg-2 rounded-2 ' style={{backgroundColor:"#001C79", color:"white"}}>Central Committees</div>
        </Link>

        <Link href="/ficac-committees/regions-committees" className='text-decoration-none'>
        <div className='px-3 py-3 py-lg-2 rounded-2 ' style={{backgroundColor:"white", color:"#001C79" , border:"1px solid #001C79"}}>Regions Committees</div>
        </Link>
      </Col>
    </Row>
